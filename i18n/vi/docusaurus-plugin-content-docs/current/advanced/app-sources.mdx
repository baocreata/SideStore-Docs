...
description: Hướng dẫn về nguồn ứng dụng thủ công.
---

# Tạo nguồn ứng dụng

SideStore hoàn toàn tương thích với AltSources. [Các nguồn tài nguyên AltStore chính thức](https://faq.altstore.io/developers/make-a-source) cung cấp mọi thông tin chi tiết bạn cần để tạo AltSource của riêng mình. AltSources cho phép bạn xem, cài đặt và cập nhật tất cả các ứng dụng khả dụng của bạn một cách dễ dàng trên cả AltStore và SideStore.
